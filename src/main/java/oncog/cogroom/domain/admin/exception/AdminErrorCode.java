...
public enum AdminErrorCode implements BaseErrorCode {
    ...
    INVALID_QUESTION_LEVEL_ERROR("INVALID_QUESTION_LEVEL_ERROR", HttpStatus.BAD_REQUEST, "유효하지 않은 난이도입니다."),
    CATEGORY_EMPTY_ERROR("CATEGORY_EMPTY_ERROR", HttpStatus.BAD_REQUEST, "카테고리를 최소 한 개 이상 입력해주세요."),
    CATEGORY_NOT_FOUND_ERROR("QUESTION_CATEGORY_NOT_FOUND", HttpStatus.BAD_REQUEST, "존재하지 않는 카테고리입니다.");
